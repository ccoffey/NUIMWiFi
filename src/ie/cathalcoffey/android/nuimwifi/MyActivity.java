...
public class MyActivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        button.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View v)
            {
                ...
                if (username.equalsIgnoreCase("cathal")
                        && password.equalsIgnoreCase("coffey"))
                {
    ...
    protected void onPause()
    {
        ...
        if (!(username.equalsIgnoreCase("cathal") && password
                .equalsIgnoreCase("coffey")))
        {
            spe = PreferenceManager.getDefaultSharedPreferences(
                    getApplicationContext()).edit();

            editTextUsername = (EditText) findViewById(R.id.editText1);
            spe.putString("@string/username", editTextUsername.getText()
                    .toString());

            editTextPassword = (EditText) findViewById(R.id.editText2);
            spe.putString("@string/password", editTextPassword.getText()
                    .toString());
